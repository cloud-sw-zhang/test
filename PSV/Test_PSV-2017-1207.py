''' [PSV-2017-1207] There is a root level command injection vulnerability in the device_name parameter on the lan.cgi page   '''
...
def test_Step_1():
    log.info('step-1 There is a root level command injection vulnerability in the device_name parameter on the lan.cgi page ')
    url = host + urlLANSetup
...
def test_Step_2():
    log.info( 'step-2 Check file in console ')
