...
def test_Step_5():
    ...
    time.sleep(GenieWaitTime)
    ssidname5g = driver.find_element_by_id("com.dragonflow:id/wirelesssetting_name").get_attribute('text')
    passphrasename5g = driver.find_element_by_id("com.dragonflow:id/wirelesssetting_key").get_attribute('text')
    securityname5g = driver.find_element_by_id("com.dragonflow:id/wirelesssetting_security_value").get_attribute('text')
    width = driver.get_window_size()['width']
    height = driver.get_window_size()['height']
    driver.swipe(width / 2, height * 3 / 4, width / 2, height / 4, 500)
    time.sleep(2)
    channelname5g = ''
    channelname5g = driver.find_element_by_id("com.dragonflow:id/wirelesssetting_channle").get_attribute('text')
    driver.swipe(width / 2, height / 4, width / 2, height * 3 / 4, 500)   
    time.sleep(5)
    driver.quit()
    if ssidname5g == 'GenieAPP_ATE_5G' and passphrasename5g == '88888888' and securityname5g.find('WPA2-PSK') != -1 and channelname5g != '':
        case5Gresult = 'pass'
    else:
        case5Gresult = 'fail'
    assert case5Gresult == 'pass', "Genie app check wireless settings pass" 

def test_Step_6():
    log.info('step-6 Use Genie app to modify wireless settings-5g')
#==== modify 5G wireless setting  
    from appium import webdriver
    print 'modify 5G wireless setting '
    desired_caps = {}
    desired_caps['platformName'] = 'Android'
    desired_caps['platformVersion'] = '4.4.2'
    desired_caps['deviceName'] = '7e2b2d2'
    ...
    driver.find_element_by_id("com.dragonflow:id/wirelesssetting_name").send_keys('Genie_ATE_5G')
    driver.hide_keyboard()
    time.sleep(2)
    ...
    driver.find_element_by_id("com.dragonflow:id/wirelesssetting_chanel_currentchannel_txt").click()
    driver.find_element_by_id("com.dragonflow:id/common_toolbar_leftbtn").click()
    channel5G = driver.find_element_by_id("com.dragonflow:id/wirelesssetting_channle").get_attribute('text')
    driver.swipe(width / 2, height / 4, width / 2, height * 3 / 4, 500)
    time.sleep(2)
...
def test_Step_7():
    ...
    if ssid5g == 'Genie_ATE_5G' and passpharse5g == '99999999':
        caseresult = 'pass'
    else:
        caseresult = 'fail'
...
def test_Step_8():
    log.info('step-8 Android device 5G connect to DUT')
    from appium import webdriver
    desired_caps = {}
    desired_caps['platformName'] = 'Android'
    desired_caps['platformVersion'] = '4.4.2'
    ...
    if str == 'Genie_ATE_5G':
        ...
        #a = driver.available_ime_engines
        driver.activate_ime_engine('com.google.android.inputmethod.pinyin/.PinyinIME')
        driver.find_element_by_class_name('android.widget.EditText').send_keys('Genie_ATE_5G')
        driver.find_element_by_id("android:id/text1").click()
        driver.find_element_by_android_uiautomator('new UiSelector().text("WPA/WPA2 PSK")').click() 
        ...
        str = ''
        try:
            str = driver.find_element_by_name(u"Genie_ATE_5G")
        except:
            print 'pass'
        driver.quit()
        if str == '':
